...
if __name__ == "__main__":
    ...
    data_train = ImageFolder("~/data/Master/places_reduced/train", transform=transformation)
    data_test = ImageFolder("~/data/Master/places_reduced/val", transform=transformation) 
